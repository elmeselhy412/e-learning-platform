...
import { Body, Controller, Post, Get, HttpException, HttpStatus, UseGuards, Query, Put, Param, Delete } from '@nestjs/common';
...
export class UserController {
  constructor(private readonly userService: UserService, private readonly failedLoginService: FailedLoginService) { }
